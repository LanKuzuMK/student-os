...
<div class="nav-group"><div class="nav-title">Skills</div><a href="/skills/discover" class="nav-link" style="background-color:var(--border-color)">Discover</a><a href="/skills" class="nav-link">My Skills</a></div>
