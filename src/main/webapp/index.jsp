...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .logo-orbit { position: relative; display: grid; width: 96px; height: 96px; margin: 0 auto 25px; place-items: center; border: 1px solid rgba(223, 228, 245, .9); border-radius: 30px; background: linear-gradient(145deg, #ffffff, #f4f5ff); box-shadow: 0 20px 45px rgba(41, 56, 111, .12), inset 0 1px 0 rgba(255,255,255,.9); }
        .logo-orbit::before { position: absolute; inset: -8px; z-index: 0; border: 1px solid rgba(91, 92, 226, .18); border-radius: 35px; content: ''; }
        .logo-orbit img { position: relative; z-index: 1; width: 67px; height: 67px; object-fit: contain; filter: drop-shadow(0 9px 14px rgba(50, 66, 196, .24)); }
...
<body>
    <main class="landing">
        <header class="topbar">
            <a class="brand" href="/"><img class="brand-mark" src="/favicon.png" alt="StudentOS logo">StudentOS</a>
            <a class="topbar-link" href="/auth/signin">Sign in</a>
        </header>

        <section class="hero" aria-labelledby="landing-title">
            <div class="hero-copy">
                <div class="logo-orbit"><img src="/favicon.png" alt="StudentOS logo"></div>
